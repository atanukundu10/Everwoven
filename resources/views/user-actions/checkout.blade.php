                ...
                <div class="row g-5">
                    <div class="col-md-12 col-lg-6 col-xl-7">
                        ...
                        <div class="form-check mb-3">
                            <label class="form-check-label" for="createAccountPrompt">
                                Don't have an account? <a href="{{ url('/signup') }}">Create Now</a>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6 col-xl-5">
                        <div class="table-responsive">
                            <div class="row g-4 text-center align-items-center justify-content-center border-bottom py-3">
                                <div class="col-12">
                                    <div class="form-check text-start my-3">
                                        <input type="radio" class="form-check-input bg-primary border-0" id="Transfer-1" name="payment_method" value="Transfer">
                            ...
                            <div class="row g-4 text-center align-items-center justify-content-center pt-4">
                                <button type="submit" class="btn btn-primary py-3 px-4 text-uppercase w-100 rounded-3">Place Order</button>
                            </div>
                        </div>
                    </div>
            </form>
